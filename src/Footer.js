  ...
  return (    
    <div className="footer">
      <p>
        ...
        Questo piccolo contributo è il mio ringraziamento al lavoro di chi aiuta l'intero paese a resistere contro questa grande crisi. Ai medici, alle forze armate, alla protezione civile e a ogni singolo italiano che presta attenzione alla cura dell'altro, <strong>Grazie</strong></p>
