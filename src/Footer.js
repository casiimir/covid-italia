...
const Footer = () => {
  return (    
    <div className="footer">
      ...
      <p>Realizzato con ❤️ da <a href="https://www.linkedin.com/in/casimiro-p-ciancimino/">Casimiro</a> <br /><italic style={{fontSize: "0.8em"}}>Illustration by <a href="https://dribbble.com/Ivan_Haidutski">Ivan Haidutski</a> from <a href="https://icons8.com/">Icons8</a></italic></p>
    </div>
  )
}
